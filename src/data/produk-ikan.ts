 ...
 *     perairan umum (Waduk Mrica) Banjarnegara. Volume produksi resmi BPS hanya
 *     dipublikasikan per tempat pemeliharaan / alat tangkap — TIDAK per jenis ikan —
 *     sehingga rincian per jenis di halaman /fisheries adalah ESTIMASI komposisi
 *     (pangsa % indikatif khas komoditas air tawar Banjarnegara), bukan angka BPS.
 ...
 *
 * Update: cukup sunting entri di bawah (hargaMin/hargaMax/pangsa/deskripsi).
 */
 ...
 * minapadi), disusul nila/mujair; tangkap Waduk Mrica menambah nila/mujair,
 * gabus & belut. Bukan angka BPS — hanya basis estimasi rincian per jenis. */
