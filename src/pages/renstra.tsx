        ...
        <div className="print-block bg-white border border-slate-200 p-6 shadow-sm text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono font-bold text-xs uppercase text-slate-700">
            ...
            <div className="p-4 border border-dashed border-slate-300">
              ...
              <p className="text-[10px] text-slate-500 leading-relaxed font-bold">Memberdayakan petani, pembudidaya ikan, dan peternak melalui penerapan teknologi tepat guna lokal.</p>
            </div>
            <div className="p-4 border border-dashed border-slate-300">
              <span className="text-emerald-700 block mb-1">03. Pendapatan Pelaku Usaha</span>
              <p className="text-[10px] text-slate-500 leading-relaxed font-bold">Meningkatkan kesejahteraan pelaku usaha pertanian lewat kenaikan nilai tambah, efisiensi produksi, dan akses pasar.</p>
            </div>
            <div className="p-4 border border-dashed border-slate-300">
              <span className="text-emerald-700 block mb-1">04. Akuntabilitas & Pelayanan</span>
              <p className="text-[10px] text-slate-500 leading-relaxed font-bold">Mewujudkan tata kelola pemerintahan yang baik, transparan, dan berorientasi penuh pada kepuasan masyarakat.</p>
            </div>
          </div>
        </div>
                ...
                {comparisons.map((c, idx) => (
                  <tr key={idx} className="border-b border-slate-300 hover:bg-slate-50">
                    ...
                    <td className="p-3 font-bold text-slate-700 uppercase">
                      {c.indikator}
                      <span className="block text-[9px] font-normal text-slate-400 normal-case mt-0.5">{c.keterangan}</span>
                    </td>
