  ...
  return (
    <DefaultLayout>
      <section className="flex flex-col gap-8 py-2">
        ...
        <div className="bg-emerald-100 border-2 border-[#171717] p-8 rounded-none shadow-[4px_4px_0px_0px_#171717] flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-6 flex-wrap md:flex-nowrap">
            <div className="h-20 w-20 bg-white border-2 border-[#171717] shadow-[2px_2px_0px_0px_#171717] flex items-center justify-center font-serif font-black text-2xl rotate-[-2deg] text-emerald-600 shrink-0">
              JDN
            </div>
            <div>
              <h2 className="text-3xl font-serif font-black text-[#171717] uppercase tracking-tight">Jaga Data Nusantara (JDN)</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            <div className="bg-white border-2 border-[#171717] p-6 rounded-none shadow-[4px_4px_0px_0px_#171717]">
              <h3 className="text-sm font-serif font-black uppercase tracking-widest text-[#171717] mb-4 flex items-center gap-2 border-b-2 border-[#171717] pb-2">
            ...
            <div className="bg-emerald-50 border-2 border-[#171717] p-6 rounded-none shadow-[4px_4px_0px_0px_#171717]">
              <h3 className="text-sm font-serif font-black uppercase tracking-widest text-emerald-950 mb-4 flex items-center gap-2 border-b-2 border-[#171717] pb-2">
          ...
          {/* Right Column */}
          <div className="bg-white border-2 border-[#171717] p-6 rounded-none shadow-[4px_4px_0px_0px_#171717]">
            <h3 className="text-sm font-serif font-black uppercase tracking-widest text-[#171717] mb-6 flex items-center gap-2 border-b-2 border-[#171717] pb-2">
            ...
            <ul className="space-y-5 font-mono font-bold text-xs">
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 border-2 border-[#171717] bg-green-100 flex items-center justify-center flex-shrink-0 shadow-[1px_1px_0px_0px_#171717]">
                  <Sprout className="w-4 h-4 text-green-700" />
                </div>
                <div>
                  <h4 className="font-serif font-black uppercase text-[11px] text-[#171717]">Korelasi Lahan & Komoditas</h4>
              ...
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 border-2 border-[#171717] bg-blue-100 flex items-center justify-center flex-shrink-0 shadow-[1px_1px_0px_0px_#171717]">
                  <Network className="w-4 h-4 text-blue-700" />
                </div>
                <div>
                  <h4 className="font-serif font-black uppercase text-[11px] text-[#171717]">Time-Series Laju Produksi</h4>
              ...
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 border-2 border-[#171717] bg-yellow-100 flex items-center justify-center flex-shrink-0 shadow-[1px_1px_0px_0px_#171717]">
                  <Info className="w-4 h-4 text-yellow-700" />
                </div>
                <div>
                  <h4 className="font-serif font-black uppercase text-[11px] text-[#171717]">Indeks Volatilitas Harga</h4>
        ...
        <div className="bg-white border-2 border-[#171717] p-8 rounded-none shadow-[4px_4px_0px_0px_#171717]">
          <div className="text-center mb-8 border-b-2 border-dashed border-[#171717] pb-6">
            <span className="inline-block px-3 py-1 bg-purple-200 border-2 border-[#171717] font-mono font-black text-xs uppercase shadow-[2px_2px_0px_0px_#171717]">
              Peta Jalan JDN
            </span>
            <h3 className="text-2xl font-serif font-black text-[#171717] uppercase mt-3">Pengembangan Analitik Pertanian</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 font-mono font-bold text-xs">
            ...
            <div className="bg-neutral-50 border-2 border-[#171717] p-5 shadow-[3px_3px_0px_0px_#171717] flex flex-col justify-between hover:shadow-[4px_4px_0px_0px_#171717] transition-all">
              <div>
                <div className="w-9 h-9 border-2 border-[#171717] bg-indigo-100 flex items-center justify-center mb-4 shadow-[1.5px_1.5px_0px_0px_#171717]">
                  <Brain className="w-5 h-5 text-indigo-700" />
                </div>
                <h4 className="font-serif font-black uppercase text-[#171717] mb-2 leading-tight">Predictive AI</h4>
            ...
            <div className="bg-neutral-50 border-2 border-[#171717] p-5 shadow-[3px_3px_0px_0px_#171717] flex flex-col justify-between hover:shadow-[4px_4px_0px_0px_#171717] transition-all">
              <div>
                <div className="w-9 h-9 border-2 border-[#171717] bg-purple-100 flex items-center justify-center mb-4 shadow-[1.5px_1.5px_0px_0px_#171717]">
                  <GitMerge className="w-5 h-5 text-purple-700" />
                </div>
                <h4 className="font-serif font-black uppercase text-[#171717] mb-2 leading-tight">Korelasi Lahan</h4>
            ...
            <div className="bg-neutral-50 border-2 border-[#171717] p-5 shadow-[3px_3px_0px_0px_#171717] flex flex-col justify-between hover:shadow-[4px_4px_0px_0px_#171717] transition-all">
              <div>
                <div className="w-9 h-9 border-2 border-[#171717] bg-rose-100 flex items-center justify-center mb-4 shadow-[1.5px_1.5px_0px_0px_#171717]">
                  <MessageSquare className="w-5 h-5 text-rose-700" />
                </div>
                <h4 className="font-serif font-black uppercase text-[#171717] mb-2 leading-tight">Sentimen Pasar</h4>
            ...
            <div className="bg-neutral-50 border-2 border-[#171717] p-5 shadow-[3px_3px_0px_0px_#171717] flex flex-col justify-between hover:shadow-[4px_4px_0px_0px_#171717] transition-all">
              <div>
                <div className="w-9 h-9 border-2 border-[#171717] bg-teal-100 flex items-center justify-center mb-4 shadow-[1.5px_1.5px_0px_0px_#171717]">
